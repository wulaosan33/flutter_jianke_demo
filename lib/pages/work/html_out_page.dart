          ...
          children: [
            GestureDetector(
                onTap: () {
                  push(
                      context: context,
                      widget: ZeroHtmlWidget('https://www.biquge.com/'));
                },
                child: Container(
            ...
            GestureDetector(
                onTap: () {
                  push(
                      context: context,
                      widget: ZeroHtmlWidget('https://www.toutiao.com/'));
                },
                child: Container(
                  margin: EdgeInsets.all(20),
                  height: 40,
            ...
            GestureDetector(
                onTap: () {
                  push(
                      context: context,
                      widget: ZeroHtmlWidget('https://www.zhihu.com/'));
                },
                child: Container(
                  margin: EdgeInsets.all(20),
                  height: 40,
            ...
            GestureDetector(
                onTap: () {
                  push(
                      context: context,
                      widget: ZeroHtmlWidget('https://www.jianshu.com/'));
                },
                child: Container(
                  margin: EdgeInsets.all(20),
                  height: 40,
            ...
            GestureDetector(
                onTap: () {
                  push(
                      context: context,
                      widget: ZeroHtmlWidget('https://www.huxiu.com/'));
                },
                child: Container(
                  margin: EdgeInsets.all(20),
                  height: 40,
