          ...
          Column(
            children: [
              FlatButton(
                ...
                onPressed: (){
                  CupertinoPick.pickImage(
                      context,
                          (List<File> file) async {
                        if (file.isNotEmpty) {
                          for (File planet in file) {
                            String imgBase64 = base64Encode(await planet.readAsBytes());
                            setState((){
              ...
              Container(
                  ...
                  child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return imgItem(index,imageList,NumUtil.divide(NumUtil.subtract(MediaQuery.of(context).size.width,60.0), 3.0));
                      }
                  )
              )
            ],
        ...
        return GestureDetector(
          child: Container(
            child: Offstage(
              ...
              child: Base64Image(imageList[index], width: imageWH, heigth: imageWH,),
            ),
          ),
          onTap: () {
